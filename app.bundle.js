...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FileUpload = __webpack_require__(236);
	
	var _FileUpload2 = _interopRequireDefault(_FileUpload);
	
	var _FileList = __webpack_require__(239);
	...
	var App = (function (_React$Component) {
	  ...
	  function App() {
	    ...
	    _this.store.subscribe(function () {
	      _this.setState(_this.store.getState().toJS());
	    });
	    return _this;
	  }
	  ...
	  (0, _createClass3.default)(App, [{
	    key: 'addTextToStore',
	    value: function addTextToStore(textId, text) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var def = __webpack_require__(190).setDesc
	  , has = __webpack_require__(196)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toIObject = __webpack_require__(206)
	  , getNames  = __webpack_require__(190).getNames
	  , toString  = {}.toString;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getDesc  = __webpack_require__(190).getDesc
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _immutable = __webpack_require__(234);
...
/***/ function(module, exports) {
	 ...
	 * action types
	 */
	var ADD_TEXT = exports.ADD_TEXT = 'ADD_TEXT';
	var REMOVE_TEXT = exports.REMOVE_TEXT = 'REMOVE_TEXT';
	
	/*
	 * action creators
	 */
	function addText(textId, text) {
	  return { type: ADD_TEXT, textId: textId, text: text };
	}
	
	function removeText(textId) {
	  return { type: REMOVE_TEXT, textId: textId };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FileUpload = (function (_React$Component) {
	  ...
	  function FileUpload() {
	    ...
	    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(FileUpload).call(this));
	  }
	  ...
	  (0, _createClass3.default)(FileUpload, [{
	    ...
	    value: function readTextFile(file) {
	      ...
	      reader.onloadend = function (e) {
	        if (e.target.readyState == FileReader.DONE) {
	          ...
	          _this2.props.add(file.name, content);
	        }
	      };
	    ...
	    value: function onDrop(files) {
	      ...
	      files.forEach(function (file) {
	        return _this3.readTextFile(file);
	      });
	    }
	  }, {
	    key: 'onOpenClick',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _attrAccept = __webpack_require__(238);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FileList = (function (_React$Component) {
	  ...
	  function FileList() {
	    ...
	    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(FileList).call(this));
	  }
